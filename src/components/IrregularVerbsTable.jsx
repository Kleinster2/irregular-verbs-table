    ...
    <div className="w-full">
      ...
      <div className="overflow-x-auto print-section">
        <table className="w-full border-collapse min-w-[640px]">
          <thead>
            <tr>
              <th className="p-2 text-center border bg-gray-100 w-1/6 text-sm md:text-base">
                <div className="flex items-center justify-center gap-2">
                  Verb (English)
                </div>
              </th>
              <th className="p-2 text-center border bg-gray-100 w-1/4 text-sm md:text-base">
                <div className="flex items-center justify-center gap-2">
                  Verb<br/>(Spanish)
                </div>
              </th>
              <th className="p-2 text-center border bg-gray-100 w-1/3 text-sm md:text-base">
                <div className="flex items-center justify-center gap-2">
                  Present Tense
                </div>
              </th>
          ...
          <tbody>
            {data.map((row, index) => (
              <tr key={index} className="hover:bg-gray-50">
                ...
                <td className="p-2 border whitespace-pre-line text-sm md:text-base">
                  {row.spanish}
                </td>
                <td className="p-2 border font-mono whitespace-pre-line text-sm md:text-base">
                  {row.present}
                </td>
                <td className="p-2 border font-mono whitespace-pre-line text-sm md:text-base">
                  {row.past}
